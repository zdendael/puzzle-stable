...
import { Puzzle, Grid3x3, Tags, Factory, Link as LinkIcon, Clock, ShoppingCart, BarChart, Menu, X, BookOpen, Handshake } from 'lucide-react'
...
export function Navigation() {
  ...
  const links: NavLink[] = [
    ...
    { to: '/collaborations', icon: Handshake, label: 'Spolupráce' },
  ...
  return (
    <>
      <nav className="bg-white dark:bg-gray-900 shadow dark:shadow-gray-800 fixed top-0 left-0 right-0 z-50">
        <div className="container mx-auto px-2 sm:px-4 max-w-[1920px]">
